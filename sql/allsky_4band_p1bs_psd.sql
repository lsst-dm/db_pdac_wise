CREATE TABLE `allsky-4band-psd-schema` (
       ...
       `w4sigmpro`    DECIMAL(4,3)  DEFAULT NULL,
        ...
        `w3pzpmag`    DECIMAL(6,4)  DEFAULT NULL,
        `w4pzpmag`    DECIMAL(6,4)  DEFAULT NULL,
           `w1pzp`    DECIMAL(6,4)  DEFAULT NULL,
           `w2pzp`    DECIMAL(6,4)  DEFAULT NULL,
           `w3pzp`    DECIMAL(6,4)  DEFAULT NULL,
           `w4pzp`    DECIMAL(6,4)  DEFAULT NULL,
        `w1azpmag`    DECIMAL(6,4)  DEFAULT NULL,
        `w2azpmag`    DECIMAL(6,4)  DEFAULT NULL,
        `w3azpmag`    DECIMAL(6,4)  DEFAULT NULL,
        `w4azpmag`    DECIMAL(6,4)  DEFAULT NULL,
           `w1azp`    DECIMAL(6,4)  DEFAULT NULL,
           `w2azp`    DECIMAL(6,4)  DEFAULT NULL,
           `w3azp`    DECIMAL(6,4)  DEFAULT NULL,
           `w4azp`    DECIMAL(6,4)  DEFAULT NULL,
